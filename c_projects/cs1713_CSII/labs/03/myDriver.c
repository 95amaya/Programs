     ...
     , char *pszCommandFileName)
{
    ...
    */
    int i = 0; // used for debugging to check each inputted line and subsequent processing of that line 
    while (fgets(szInputBuffer, 100, pfileCommand) != NULL) // On transactions now
    {
    /*    i++; // Used for debugging to skip until SHOW and CHANGE sub commands 
        if(i < 33)
            continue;*/
